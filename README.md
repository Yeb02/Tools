1- launay_tables can easily be modified to "concatenate" frames into a video (jpg or png to avi), and create this frames with openCV or matplotlib. Useful if it can't be done live.
